...
enum class EOnlinePlatform : uint8_t
{
	...
	OnlinePlatform_QQ              = 5,
	OnlinePlatform_NNX             = 6,
	OnlinePlatform_PsyNet          = 7,
	OnlinePlatform_MAX             = 8
};
...
struct FPostProcessSettings
{
	...
	TEnumAsByte<EFocusType>                            DOF_FocusType;                                            // 0x0034(0x0001) (CPF_Edit)
...
struct FNetworkEncryptionKey
{
	...
	struct FUniqueNetId                                PlayerID;                                                 // 0x0030(0x0048)
	int                                                Id;                                                       // 0x0078(0x0004)
	struct FDouble                                     TimeLastUsed;                                             // 0x007C(0x0008)
};
...
struct FCoverSlot
{
	...
	TEnumAsByte<ECoverType>                            ForceCoverType;                                           // 0x0008(0x0001) (CPF_Edit)
	TEnumAsByte<ECoverType>                            CoverType;                                                // 0x0009(0x0001) (CPF_Edit, CPF_EditConst)
	TEnumAsByte<ECoverLocationDescription>             LocationDescription;                                      // 0x000A(0x0001) (CPF_Edit)
	...
	TArray<TEnumAsByte<ECoverAction>>                  Actions;                                                  // 0x0024(0x000C) (CPF_NeedCtorLink)
...
struct FSettingsPropertyPropertyMetaData
{
	...
	struct FName                                       Name;                                                     // 0x0004(0x0008) (CPF_Const)
	struct FString                                     ColumnHeaderText;                                         // 0x000C(0x000C) (CPF_Const, CPF_Localized, CPF_NeedCtorLink)
	TEnumAsByte<EPropertyValueMappingType>             MappingType;                                              // 0x0018(0x0001) (CPF_Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
...
struct FViewTargetTransitionParams
{
	...
	TEnumAsByte<EViewTargetBlendFunction>              BlendFunction;                                            // 0x0004(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0005(0x0003) MISSED OFFSET
...
struct FConnectedPeerInfo
{
	...
	unsigned long                                      bLostConnectionToHost : 1;                                // 0x004C(0x0004)
};
...
struct FFontImportOptionsData
{
	...
	TEnumAsByte<EFontImportCharacterSet>               CharacterSet;                                             // 0x0014(0x0001) (CPF_Edit)
...
struct FWaveformSample
{
	...
	TEnumAsByte<EWaveformFunction>                     LeftFunction;                                             // 0x0004(0x0001) (CPF_Edit)
	TEnumAsByte<EWaveformFunction>                     RightFunction;                                            // 0x0005(0x0001) (CPF_Edit)
	TEnumAsByte<EWaveformFunction>                     LeftTriggerFunction;                                      // 0x0006(0x0001) (CPF_Edit)
	TEnumAsByte<EWaveformFunction>                     RightTriggerFunction;                                     // 0x0007(0x0001) (CPF_Edit)
...
struct FGameSessionInformation
{
	...
	struct FUniqueNetId                                OwningNetId;                                              // 0x0064(0x0048) (CPF_Const)
	int                                                PlaylistId;                                               // 0x00AC(0x0004)
};
...
struct FPlayerInformation
{
	...
	struct FUniqueNetId                                UniqueId;                                                 // 0x0014(0x0048)
	unsigned long                                      bIsBot : 1;                                               // 0x005C(0x0004)
};
...
struct FIniLocFileEntry
{
	...
	TEnumAsByte<EOnlineEnumerationReadState>           ReadState;                                                // 0x0028(0x0001)
};
...
struct FBaseAuthSession
{
	...
	struct FUniqueNetId                                EndPointUID;                                              // 0x0018(0x0048) (CPF_Const)
};
...
{
	int                                                SessionUID;                                               // 0x0060(0x0004) (CPF_Const)
};
...
{
	TEnumAsByte<EAuthStatus>                           AuthStatus;                                               // 0x0060(0x0001) (CPF_Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0061(0x0003) MISSED OFFSET
	int                                                AuthTicketUID;                                            // 0x0064(0x0004) (CPF_Const)
};
...
{
	struct FUniqueNetId                                PlayerID;                                                 // 0x0000(0x0048) (CPF_Const)
	struct FSettingsData                               Rank;                                                     // 0x0048(0x000C) (CPF_Const)
	struct FString                                     Nickname;                                                 // 0x0054(0x000C) (CPF_Const, CPF_NeedCtorLink)
	TArray<struct FOnlineStatsColumn>                  Columns;                                                  // 0x0060(0x000C) (CPF_NeedCtorLink)
	TArray<struct FSettingsData>                       StatValues;                                               // 0x006C(0x000C) (CPF_NeedCtorLink)
};
...
struct FWeightNodeRule
{
	...
	TEnumAsByte<EWeightCheck>                          WeightCheck;                                              // 0x0010(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
...
struct FNxDestructibleDepthParameters
{
	...
	TEnumAsByte<EImpactDamageOverride>                 ImpactDamageOverride;                                     // 0x0004(0x0001) (CPF_Edit)
};
...
struct FNxDestructibleParameters
{
	...
	TEnumAsByte<ERBCollisionChannel>                   DynamicChunksChannel;                                     // 0x00E4(0x0001) (CPF_Edit, CPF_Const)
...
{
	float                                              Time;                                                     // 0x0000(0x0004)
	TEnumAsByte<EHeadTrackingAction>                   Action;                                                   // 0x0004(0x0001) (CPF_Edit)
};
...
{
	float                                              Time;                                                     // 0x0000(0x0004)
	TEnumAsByte<ETrackToggleAction>                    ToggleAction;                                             // 0x0004(0x0001) (CPF_Edit)
};
...
{
	float                                              Time;                                                     // 0x0000(0x0004)
	TEnumAsByte<EVisibilityTrackAction>                Action;                                                   // 0x0004(0x0001) (CPF_Edit)
...
struct FLayerBlendInput
{
	...
	TEnumAsByte<ELandscapeLayerBlendType>              BlendType;                                                // 0x0008(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
...
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (CPF_Edit)
	TEnumAsByte<EParticleSysParamType>                 ParamType;                                                // 0x0008(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
...
{
	TEnumAsByte<EParticleAttractorActionType>          Type;                                                     // 0x0000(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
...
{
	TEnumAsByte<EParticleEventType>                    Type;                                                     // 0x0000(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
...
struct FEmitterDynamicParameter
{
	...
	TEnumAsByte<EEmitterDynamicParameterValue>         ValueMethod;                                              // 0x000C(0x0001) (CPF_Edit)
...
{
	TEnumAsByte<EDamageParameterOverrideMode>          OverrideMode;                                             // 0x0000(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
...
{
	struct FUniqueNetId                                SendingPlayerId;                                          // 0x0000(0x0048)
	struct FString                                     SendingPlayerNick;                                        // 0x0048(0x000C) (CPF_NeedCtorLink)
	unsigned long                                      bIsFriendInvite : 1;                                      // 0x0054(0x0004)
	unsigned long                                      bIsGameInvite : 1;                                        // 0x0054(0x0004)
	unsigned long                                      bWasAccepted : 1;                                         // 0x0054(0x0004)
	unsigned long                                      bWasDenied : 1;                                           // 0x0054(0x0004)
	struct FString                                     Message;                                                  // 0x0058(0x000C) (CPF_NeedCtorLink)
};
...
struct FOnlineFriend
{
	...
	struct FString                                     PlayerName;                                               // 0x0050(0x000C) (CPF_NeedCtorLink)
	struct FString                                     PresenceInfo;                                             // 0x005C(0x000C) (CPF_NeedCtorLink)
	TEnumAsByte<EOnlineFriendState>                    FriendState;                                              // 0x0068(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0069(0x0003) MISSED OFFSET
	unsigned long                                      bIsOnline : 1;                                            // 0x006C(0x0004)
	unsigned long                                      bIsPlaying : 1;                                           // 0x006C(0x0004)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x006C(0x0004)
	unsigned long                                      bIsJoinable : 1;                                          // 0x006C(0x0004)
	unsigned long                                      bHasVoiceSupport : 1;                                     // 0x006C(0x0004)
	unsigned long                                      bHaveInvited : 1;                                         // 0x006C(0x0004)
	unsigned long                                      bHasInvitedYou : 1;                                       // 0x006C(0x0004)
	int                                                GroupId;                                                  // 0x0070(0x0004) (CPF_Const)
	unsigned long                                      bIsBlocked : 1;                                           // 0x0074(0x0004)
};
...
{
	struct FUniqueNetId                                UniqueId;                                                 // 0x0000(0x0048) (CPF_Const)
	struct FString                                     Nickname;                                                 // 0x0048(0x000C) (CPF_Const, CPF_NeedCtorLink)
	unsigned char                                      LocalUserNum;                                             // 0x0054(0x0001) (CPF_Const)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0055(0x0001) (CPF_Const)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0056(0x0002) MISSED OFFSET
	int                                                TitleId;                                                  // 0x0058(0x0004) (CPF_Const)
	unsigned long                                      bIsLocal : 1;                                             // 0x005C(0x0004) (CPF_Const)
	unsigned long                                      bIsInPartyVoice : 1;                                      // 0x005C(0x0004) (CPF_Const)
	unsigned long                                      bIsTalking : 1;                                           // 0x005C(0x0004) (CPF_Const)
	unsigned long                                      bIsInGameSession : 1;                                     // 0x005C(0x0004) (CPF_Const)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x005C(0x0004) (CPF_Const)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0060(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlinePartyMember.SessionId
	int                                                Data1;                                                    // 0x0068(0x0004) (CPF_Const)
	int                                                Data2;                                                    // 0x006C(0x0004) (CPF_Const)
	int                                                Data3;                                                    // 0x0070(0x0004) (CPF_Const)
	int                                                Data4;                                                    // 0x0074(0x0004) (CPF_Const)
};
...
struct FAchievementReward
{
	...
	TEnumAsByte<EAchievementRewardType>                RewardType;                                               // 0x0024(0x0001) (CPF_Const)
};
...
struct FAchievementMediaAsset
{
	...
	TEnumAsByte<EAchievementMediaAssetType>            AssetType;                                                // 0x000C(0x0001) (CPF_Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
struct FAchievementDetails
{
	...
	TEnumAsByte<EAchievementUnlockType>                UnlockType;                                               // 0x0044(0x0001) (CPF_Const)
	...
	TEnumAsByte<EAchievementProgressState>             ProgressState;                                            // 0x0080(0x0001) (CPF_Const)
...
struct FUIDataStoreInputAlias
{
	...
	struct FUIInputKeyData                             PlatformInputKeys[0x7];                                   // 0x0008(0x0018) (CPF_Config, CPF_NeedCtorLink)
};
...
{
	TEnumAsByte<ESoundClassName>                       SoundClassName;                                           // 0x0000(0x0001) (CPF_Edit, CPF_Transient)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
...
struct FSkelMeshComponentLODInfo
{
	...
	TEnumAsByte<EInstanceWeightUsage>                  InstanceWeightUsage;                                      // 0x0010(0x0001) (CPF_Const, CPF_Transient)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
...
struct FBoneMirrorInfo
{
	...
	TEnumAsByte<EAxis>                                 BoneFlipAxis;                                             // 0x0004(0x0001) (CPF_Edit)
};
...
{
	TEnumAsByte<ETriangleSortOption>                   TriangleSorting;                                          // 0x0000(0x0001) (CPF_Edit)
	TEnumAsByte<ETriangleSortAxis>                     CustomLeftRightAxis;                                      // 0x0001(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
...
struct FSkeletalMeshLODInfo
{
	...
	TArray<TEnumAsByte<ETriangleSortOption>>           TriangleSorting;                                          // 0x0020(0x000C) (CPF_NeedCtorLink, CPF_Deprecated)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	TEnumAsByte<ESkeletalMeshOptimizationNormalMode>   NormalMode;                                               // 0x0008(0x0001) (CPF_Deprecated)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
...
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (CPF_Edit)
	TEnumAsByte<EClothBoneType>                        BoneType;                                                 // 0x0008(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
...
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (CPF_Edit)
	TEnumAsByte<ESoftBodyBoneType>                     BoneType;                                                 // 0x0008(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	TArray<int>                                        AttachedVertexIndices;                                    // 0x000C(0x000C) (CPF_Const, CPF_NeedCtorLink)
};
...
struct FClientConnectionStats
{
	...
	int                                                MaxOutBPS;                                                // 0x0040(0x0004)
	int                                                TotalOutBPS;                                              // 0x0044(0x0004)
	float                                              CurrentLatency;                                           // 0x0048(0x0004)
	float                                              CurrentJitter;                                            // 0x004C(0x0004)
};
...
struct FFOscillator
{
	...
	TEnumAsByte<EInitialOscillatorOffset>              InitialOffset;                                            // 0x0008(0x0001) (CPF_Edit)
};
...
struct FFriendsQuery
{
	...
	unsigned long                                      bIsFriend : 1;                                            // 0x0048(0x0004)
};
...
{
	TArray<unsigned char>                              Key;                                                      // 0x0000(0x000C) (CPF_NeedCtorLink)
...
struct FDownloadedWorkshopData
{
	...
	struct FUniqueNetId                                AuthorNetID;                                              // 0x0020(0x0048)
	class UTexture2DDynamic*                           Preview;                                                  // 0x0068(0x0004) (CPF_DataBinding)
	class UTexture*                                    Avatar;                                                   // 0x006C(0x0004) (CPF_DataBinding)
	struct FString                                     Description;                                              // 0x0070(0x000C) (CPF_NeedCtorLink, CPF_DataBinding)
	struct FString                                     PreviewURL;                                               // 0x007C(0x000C) (CPF_NeedCtorLink, CPF_DataBinding)
	struct FString                                     ItemPath;                                                 // 0x0088(0x000C) (CPF_NeedCtorLink, CPF_DataBinding)
	struct FString                                     Filename;                                                 // 0x0094(0x000C) (CPF_NeedCtorLink, CPF_DataBinding)
	struct FString                                     FullPath;                                                 // 0x00A0(0x000C) (CPF_NeedCtorLink, CPF_DataBinding)
};
...
struct FCommunityContentFile
{
	...
	struct FUniqueNetId                                Owner;                                                    // 0x001C(0x0048)
	int                                                DownloadCount;                                            // 0x0064(0x0004)
	float                                              AverageRating;                                            // 0x0068(0x0004)
	int                                                RatingCount;                                              // 0x006C(0x0004)
	int                                                LastRatingGiven;                                          // 0x0070(0x0004)
	struct FString                                     LocalFilePath;                                            // 0x0074(0x000C) (CPF_NeedCtorLink)
};
...
struct FLobbyMember
{
	...
	TArray<struct FLobbyMetaData>                      PlayerSettings;                                           // 0x0048(0x000C) (CPF_NeedCtorLink)
	struct FString                                     OnlineName;                                               // 0x0054(0x000C) (CPF_NeedCtorLink)
};
...
{
	struct FUniqueLobbyId                              LobbyUID;                                                 // 0x0000(0x000C)
	TArray<struct FLobbyMetaData>                      LobbySettings;                                            // 0x000C(0x000C) (CPF_NeedCtorLink)
};
...
{
	TArray<struct FLobbyMember>                        Members;                                                  // 0x0018(0x000C) (CPF_NeedCtorLink)
};
...
struct FLobbyFilter
{
	struct FString                                     Key;                                                      // 0x0000(0x000C) (CPF_NeedCtorLink)
	struct FString                                     Value;                                                    // 0x000C(0x000C) (CPF_NeedCtorLink)
	TEnumAsByte<EOnlineGameSearchComparisonType>       Operator;                                                 // 0x0018(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
...
struct FMarketplaceInventoryItem
{
	...
	TEnumAsByte<EInventoryItemState>                   ItemState;                                                // 0x000D(0x0001) (CPF_Const)
...
struct FMarketplaceProductDetails
{
	...
	TEnumAsByte<EOnlineEnumerationReadState>           DetailsReadState;                                         // 0x004C(0x0001)
...
struct FSessionMemberInfo
{
	...
	TEnumAsByte<ESessionMemberStatus>                  MemberStatus;                                             // 0x0048(0x0001)
};
...
{
	struct FUniqueNetId                                TalkerId;                                                 // 0x0000(0x0048)
	float                                              LastNotificationTime;                                     // 0x0048(0x0004)
	unsigned long                                      bWasTalking : 1;                                          // 0x004C(0x0004)
	unsigned long                                      bIsTalking : 1;                                           // 0x004C(0x0004)
	unsigned long                                      bIsRegistered : 1;                                        // 0x004C(0x0004)
};
...
{
	struct FUniqueNetId                                TalkerId;                                                 // 0x0000(0x0048)
	unsigned long                                      bHasVoice : 1;                                            // 0x0048(0x0004)
	unsigned long                                      bHasNetworkedVoice : 1;                                   // 0x0048(0x0004)
	unsigned long                                      bIsRecognizingSpeech : 1;                                 // 0x0048(0x0004)
	unsigned long                                      bWasTalking : 1;                                          // 0x0048(0x0004)
	unsigned long                                      bIsTalking : 1;                                           // 0x0048(0x0004)
	unsigned long                                      bIsRegistered : 1;                                        // 0x0048(0x0004)
};
...
struct FOnlineProfile
{
	...
	TEnumAsByte<EOnlineAccountTier>                    AccountTier;                                              // 0x000C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
struct FPendingClientAuth
{
	...
	struct FUniqueNetId                                ClientUID;                                                // 0x0004(0x0048)
	float                                              AuthTimestamp;                                            // 0x004C(0x0004)
	int                                                AuthRetryCount;                                           // 0x0050(0x0004)
};
...
{
	struct FUniqueNetId                                ClientUID;                                                // 0x0000(0x0048)
	int                                                AuthRetryCount;                                           // 0x0048(0x0004)
};
...
struct FInputKeyAction
{
	...
	TEnumAsByte<EInputEvent>                           InputKeyState;                                            // 0x0008(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
...
struct FInputEventParameters
{
	...
	TEnumAsByte<EInputEvent>                           EventType;                                                // 0x0010(0x0001) (CPF_Const, CPF_Transient, CPF_AlwaysInit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
...
struct FRecentParty
{
	...
	TArray<struct FUniqueNetId>                        PartyMembers;                                             // 0x0048(0x000C) (CPF_NeedCtorLink)
};
...
struct FBoneMirrorExport
{
	...
	TEnumAsByte<EAxis>                                 BoneFlipAxis;                                             // 0x0010(0x0001) (CPF_Edit)
};
